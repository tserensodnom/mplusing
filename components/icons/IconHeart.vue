<template>
  <svg
    v-if="liked"
    class="inline-block align-middle mr-2 w-5 transition duration-150 transform group-focus:scale-150"
    viewBox="0 0 24 24"
  >
    <path
      class="fill-current"
  ...
  <svg v-else class="inline-block align-middle mr-2 w-5" viewBox="0 0 24 24">
    <path
      class="fill-current"
