...
export default {
  ...
  publicRuntimeConfig: {
    buyUrl: process.env.BUY_URL || 'https://buy.mplus.mn',
    apiUrl: process.env.API_URL || 'https://api.mplus.mn',
    baseUrl: process.env.BASE_URL || 'https://www.mplus.mn',
    authBaseUrl: process.env.AUTH_BASE_URL || 'https://mplus.mn',
    accountApiUrl: 'https://api.mplus.mn',

    axios: {
      browserBaseURL: process.env.API_URL || 'https://api.mplus.mn',
    },
  },

  privateRuntimeConfig: {
    axios: {
      baseURL: process.env.API_URL || 'https://api.mplus.mn',
    },
  },
}
